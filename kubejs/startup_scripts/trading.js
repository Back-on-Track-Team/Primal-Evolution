...
StartupEvents.registry('item', event => {
	...
	profession("Farming", 0xFFCC29, 0x81B214, [
		...
		{ in: MC('sweet_berries', 32), out: S(1) },
...
//		{ in: BOP('hellbark_log', 64), out: S(8) }
	...
	profession("Mining", 0x1C1124, 0x88FFF7, [
		{ in: MC('raw_iron', 16), out: S(8) },
		{ in: MC('raw_copper', 16), out: S(8) },
		{ in: CR('raw_zinc', 16), out: S(8) },
		{ in: MC('raw_gold', 16), out: S(10) },
		{ in: TE('raw_nickel', 16), out: S(12) },
		{ in: TE('raw_lead', 16), out: S(12) },
